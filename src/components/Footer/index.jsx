          ...
          <Row>
            ...
            <p className='socail-media-images'>
              <svg
                ...
                onClick={(e) => {
                  e.preventDefault();
                  window.open('https://twitter.com/ohdesignstudio', '_blank');
                }}
              >
              ...
              <svg
                ...
                onClick={(e) => {
                  e.preventDefault();
                  window.open(
                    'https://www.facebook.com/ohdesignstudio',
                    '_blank'
                  );
                }}
              >
              ...
              <svg
                ...
                onClick={(e) => {
                  e.preventDefault();
                  window.open(
                    'https://www.instagram.com/oh.design.studio/',
                    '_blank'
                  );
                }}
              >
              ...
              <svg
                ...
                onClick={(e) => {
                  e.preventDefault();
                  window.open(
                    'https://in.linkedin.com/company/oh-design-studio',
                    '_blank'
                  );
                }}
              >
              ...
              <svg
                ...
                onClick={(e) => {
                  e.preventDefault();
                  window.open(
                    'http://www.behance.net/ohdesignstudio',
                    '_blank'
                  );
                }}
              >
